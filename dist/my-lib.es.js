  ...
  proxyData() {
    return new Proxy(this, {
      ...
      set(target, p2, value) {
        ...
        if (target.data && p2 in target.data) {
          target.data[p2] = value;
          return true;
        }
        return true;
      },
      has(target, p2) {
        return p2 in target || target.data && p2 in target.data;
      }
    });
  }
}
...
function isStream(val) {
  return isObject$6(val) && isFunction$5(val.pipe);
}
...
function createInstance$2(defaultConfig2) {
  var context = new Axios(defaultConfig2);
  var instance = bind2(Axios.prototype.request, context);
  utils.extend(instance, Axios.prototype, context);
  utils.extend(instance, context);
  instance.create = function create(instanceConfig) {
    return createInstance$2(mergeConfig2(defaultConfig2, instanceConfig));
  };
  return instance;
}
var axios$1 = createInstance$2(defaults$1);
axios$1.Axios = Axios;
...
const _BaseRequest = class {
  ...
  setPost(url, data2 = {}, params = {}, config = {}) {
    this.config = __spreadValues(__spreadProps(__spreadValues({}, this.config), { url, data: data2, params }), config);
    return this;
  }
  setDown(rtUrl = false, method = "get") {
    return this;
  }
...
function isSymbol$1(value) {
  return typeof value == "symbol" || isObjectLike$3(value) && baseGetTag$4(value) == symbolTag$2;
}
...
var INFINITY$1 = 1 / 0;
var symbolProto$2 = Symbol$6 ? Symbol$6.prototype : void 0, symbolToString = symbolProto$2 ? symbolProto$2.toString : void 0;
...
var reIsNative$1 = RegExp("^" + funcToString$3.call(hasOwnProperty$e).replace(reRegExpChar$1, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
...
function baseIsArguments$2(value) {
  return isObjectLike$3(value) && baseGetTag$4(value) == argsTag$3;
}
var objectProto$c = Object.prototype;
var hasOwnProperty$c = objectProto$c.hasOwnProperty;
var propertyIsEnumerable$2 = objectProto$c.propertyIsEnumerable;
var isArguments = baseIsArguments$2(function() {
  return arguments;
}()) ? baseIsArguments$2 : function(value) {
  return isObjectLike$3(value) && hasOwnProperty$c.call(value, "callee") && !propertyIsEnumerable$2.call(value, "callee");
};
...
var isBuffer$1 = nativeIsBuffer || stubFalse$1;
...
typedArrayTags[argsTag$2] = typedArrayTags[arrayTag$1] = typedArrayTags[arrayBufferTag$2] = typedArrayTags[boolTag$2] = typedArrayTags[dataViewTag$4] = typedArrayTags[dateTag$2] = typedArrayTags[errorTag$1] = typedArrayTags[funcTag$2] = typedArrayTags[mapTag$5] = typedArrayTags[numberTag$2] = typedArrayTags[objectTag$4] = typedArrayTags[regexpTag$2] = typedArrayTags[setTag$5] = typedArrayTags[stringTag$2] = typedArrayTags[weakMapTag$3] = false;
function baseIsTypedArray(value) {
  return isObjectLike$3(value) && isLength(value.length) && !!typedArrayTags[baseGetTag$4(value)];
}
...
var nativeCreate = getNative$7(Object, "create");
...
var Map$3 = getNative$7(root$a, "Map");
var Map$4 = Map$3;
...
function isPlainObject$1(value) {
  if (!isObjectLike$3(value) || baseGetTag$4(value) != objectTag$3) {
    return false;
  }
...
var Set$4 = Set$3;
var mapTag$4 = "[object Map]", objectTag$2 = "[object Object]", promiseTag$1 = "[object Promise]", setTag$4 = "[object Set]", weakMapTag$2 = "[object WeakMap]";
...
if (DataView$3 && getTag$1(new DataView$3(new ArrayBuffer(1))) != dataViewTag$3 || Map$4 && getTag$1(new Map$4()) != mapTag$4 || Promise$4 && getTag$1(Promise$4.resolve()) != promiseTag$1 || Set$4 && getTag$1(new Set$4()) != setTag$4 || WeakMap$4 && getTag$1(new WeakMap$4()) != weakMapTag$2) {
  getTag$1 = function(value) {
    var result = baseGetTag$4(value), Ctor = result == objectTag$2 ? value.constructor : void 0, ctorString = Ctor ? toSource$3(Ctor) : "";
    if (ctorString) {
      switch (ctorString) {
...
var Uint8Array2 = root$a.Uint8Array;
...
function baseIsMap(value) {
  return isObjectLike$3(value) && getTag$2(value) == mapTag$2;
}
...
function baseClone(value, bitmask, customizer, key, object, stack) {
  ...
  if (isArr) {
    ...
    var tag = getTag$2(value), isFunc = tag == funcTag$1 || tag == genTag$1;
    if (isBuffer$2(value)) {
...
function normalizePropsOptions(comp, appContext, asMixin = false) {
  ...
  if (isArray(raw)) {
    ...
    for (const key in raw) {
      ...
      if (validatePropName(normalizedKey)) {
        const opt = raw[key];
        const prop = normalized[normalizedKey] = isArray(opt) || isFunction$3(opt) ? { type: opt } : opt;
        if (prop) {
...
function _createVNode(type, props = null, children = null, patchFlag = 0, dynamicProps = null, isBlockNode = false) {
  ...
  const shapeFlag = isString(type) ? 1 : isSuspense(type) ? 128 : isTeleport(type) ? 64 : isObject$4(type) ? 4 : isFunction$3(type) ? 2 : 0;
...
const getStyle = function(element, styleName) {
  ...
  try {
    ...
    if (style)
      return style;
    const computed2 = (_a = document.defaultView) === null || _a === void 0 ? void 0 : _a.getComputedStyle(element, "");
...
function createLoadingComponent({
  ...
  const data2 = reactive(__spreadProps2(__spreadValues$1({}, options), {
    originalPosition: "",
    originalOverflow: "",
    visible: false
  }));
  ...
  const componentSetupConfig = __spreadProps2(__spreadValues$1({}, toRefs(data2)), {
    setText,
    close,
    handleAfterLeave
  });
  ...
  return __spreadProps2(__spreadValues$1({}, componentSetupConfig), {
    vm,
    get $el() {
      return vm.el;
    }
...
const addStyle = (options, parent2, instance) => __async(void 0, null, function* () {
  const maskStyle = {};
...
const Loading$1 = function(options = {}) {
  if (isServer)
    return;
  options = __spreadValues2(__spreadValues2({}, defaults), options);
  ...
  const parent2 = options.body ? document.body : options.target;
  options.parent = parent2;
  const instance = createLoadingComponent({
    options,
    globalLoadingOption
  });
  addStyle(options, parent2, instance);
  addClassList(options, parent2, instance);
...
var isIOS = () => inBrowser$1 ? /ios|iphone|ipad|ipod/.test(navigator.userAgent.toLowerCase()) : false;
isIOS();
...
function getZIndexStyle(zIndex2) {
  var style = {};
  if (zIndex2 !== void 0) {
...
var [name$6, bem$6] = createNamespace("badge");
var badgeProps = {
  dot: Boolean,
  max: numericProp,
...
var [name$5, bem$5] = createNamespace("config-provider");
var CONFIG_PROVIDER_KEY = Symbol(name$5);
...
var [name$4, bem$4] = createNamespace("icon");
...
var _Icon = defineComponent({
  ...
  setup(props, _ref) {
    ...
    var classPrefix = computed(() => props.classPrefix || (config == null ? void 0 : config.iconPrefix) || bem$4());
    return () => {
      var {
        tag,
        dot,
...
var [name$3, bem$3] = createNamespace("loading");
...
var [name$2, bem$2] = createNamespace("overlay");
var overlayProps = {
  show: Boolean,
  zIndex: numericProp,
  duration: numericProp,
...
var [name$1, bem$1] = createNamespace("popup");
...
class LoadingRequest extends BaseRequest {
  ...
  setUseLoading(use2 = true) {
    this.isDefaultUseLoading = use2;
    return this;
  }
  ...
  reqOneOther(Model, dataKey, call) {
    return this.request().then((res) => {
      const data2 = res[dataKey];
      const model = this.getModel().newFromReq(Model, data2, call);
      return __spreadProps(__spreadValues({}, omit$1(res, dataKey)), { model });
    });
  }
  reqMany(Model, call) {
    return this.request().then((res) => {
  ...
  reqManyOther(Model, dataKey, call) {
    return this.request().then((res) => {
      ...
      return __spreadProps(__spreadValues({}, omit$1(res, dataKey)), { models });
    });
  }
}
...
class RequestModel extends BaseModel {
  ...
  static mergeUrl(prefix, suffix) {
    return `${prefix}${suffix}`;
  }
  static newReq(reqType = "default") {
    const self2 = new this();
...
export { BaseModel, LoadingRequest, RequestModel, updateConfig$1 as setLoadingClassConfig, updateConfig as setRequestClassConfig };
